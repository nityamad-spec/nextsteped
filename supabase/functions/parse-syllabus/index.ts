...
const FUNCTION_NAME = "parse-syllabus";
...
---`,
    ...
    const response = await loggedGatewayFetch(FUNCTION_NAME, { model: "google/gemini-2.5-pro", purpose: "parse-syllabus" }, "https://ai.gateway.lovable.dev/v1/chat/completions", {
      method: "POST",
      headers: {

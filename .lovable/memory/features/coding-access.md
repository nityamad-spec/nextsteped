...
- **Not built yet** (explicitly deferred): Judge0 code execution (CodingTerminalWidget is a placeholder), coding-specific lesson-plan generation, code-question mastery scoring. When Judge0 ships, it must also check coding access.

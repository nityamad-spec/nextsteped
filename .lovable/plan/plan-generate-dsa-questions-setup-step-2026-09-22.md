...
2. The step only appears when relevant: course is not an academic course, but a skilling pathway, the course's lesson plan has at least one coding week AND coding access is approved. Otherwise it is skipped automatically (Continue from Lesson Plan jumps straight to Diagnostic).

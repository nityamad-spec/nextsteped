...
## Questions
1. Should we also update the goal text on `/student/home` from "70% mastery / Goal" to "75% mastery / Goal" as part of this change?
2. Do you want a one-time in-app notice or tooltip explaining why the readiness bar moved from 70% to 75%?

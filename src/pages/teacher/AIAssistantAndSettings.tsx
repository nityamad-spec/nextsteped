  ...
  return (
    <div className="min-h-screen bg-background p-6 md:p-8">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        {/* Part 2: Enrollment & Course Settings */}
        <section className="space-y-4">
          <div>
            <h2 className="text-lg font-semibold">Enrollment and Course Settings</h2>
            <p className="text-sm text-muted-foreground">Schedule, sections, enrollment code, and roster management.</p>
          </div>

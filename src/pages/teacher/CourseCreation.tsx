    ...
    return (
      <div className="space-y-4">
        {sections.map((section, i) => {
          ...
          // Parse "Concepts & Topics" — render actual resources under each concept
          if (heading === "Concepts & Topics" || heading === "Concepts and Topics") {
            // Extract concept names from description text
            ...
            // Add any concepts from resources not mentioned in text
          ...
          // Standard sections (Overview, Learning Outcomes, Additional Tips)
          const lines = body.split("\n").filter(l => l.trim());

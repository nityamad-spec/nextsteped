...
import { ArrowRight, Eye, MessageSquare, Lightbulb, BookOpen } from "lucide-react";
...
const AITASettings = () => {
  ...
  const handleSave = () => {
    ...
    navigate("/teacher/courses/content");
  };
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">Supplements with reputable external resources for deeper understanding and real-world examples</p>
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">AI will cite course materials and external resources as used/relevant</p>
                </div>
                <Switch checked={settings.citationRequired} onCheckedChange={(v) => update({ citationRequired: v })} />
              </div>
            ...
            <CardContent>
              <div className="rounded-lg border bg-muted/30 p-4">
                ...
                <div className="space-y-3">
                  ...
                  {settings.citationRequired && (
                    <p className="text-[10px] text-muted-foreground">📚 Source: Chapter 3, "Virtual Memory" — Course Textbook</p>
                  )}
                  <div className="flex flex-wrap gap-1">
                    ...
                    {settings.citationRequired && <Badge variant="outline" className="text-[10px]">Cite Sources</Badge>}
                  </div>
                </div>
              </div>
            </CardContent>
